    ...
    >
      ...
      >
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <div className="flex flex-col items-center justify-center rounded-2xl border border-brand-outline/40 bg-gradient-to-br from-white to-sky-50/60 p-8 text-center">
          ...
          <div className="flex flex-col items-center justify-center rounded-2xl border border-brand-outline/40 bg-gradient-to-br from-white to-indigo-50/60 p-8 text-center">
          ...
          <div className="flex flex-col items-center justify-center rounded-2xl border border-brand-outline/40 bg-gradient-to-br from-white to-purple-50/60 p-8 text-center">
          ...
          <div className="flex flex-col items-center justify-center rounded-2xl border border-brand-outline/40 bg-gradient-to-br from-white to-emerald-50/60 p-8 text-center">

        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <Link
                to="/auth"
                className="text-brand-teal hover:text-brand-tealHover font-semibold transition-colors"
              >
                Đăng nhập
              </Link>
              <Link
                to="/register"
                className="bg-gradient-to-r from-brand-teal to-brand-navy text-white px-5 py-2 rounded-xl hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300 font-semibold"
              >
                Đăng ký
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-brand-teal/10 border border-brand-teal/20 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-sm font-semibold text-brand-navy">Dịch vụ gia đình hàng đầu</span>
              </div>
              ...
              <Link
                to="/auth"
                className="inline-flex items-center gap-2 bg-gradient-to-r from-brand-teal to-brand-navy text-white px-8 py-4 rounded-2xl text-lg font-semibold hover:-translate-y-0.5 hover:shadow-xl transition-all duration-300 shadow-lg"
              >
                {hero.ctaText}
            ...
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-to-br from-brand-teal/20 to-brand-navy/20 rounded-3xl blur-2xl"></div>
              <img
                src={hero.imageUrl}
                alt="Dịch vụ giúp việc"
                className="relative rounded-3xl shadow-2xl border border-brand-outline/40"
              />
            </div>
          </div>
        </div>
